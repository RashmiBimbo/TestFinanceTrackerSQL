...
BEGIN
    ...
    */
    ...
    BEGIN TRY
        ...
        DECLARE @IsApprAdmin BIT, @IsAdmin BIT, @IsApprover BIT; 
        ...
        ELSE 
            ...
            ELSE
            BEGIN
                Select 'Please enter either a valid location or a user which is either admin or approver or both!' Error;
                RETURN;
            END        
